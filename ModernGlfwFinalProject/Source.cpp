...
//
//		//view
//		unsigned int viewPos = glGetUniformLocation(shaders1.Program, "viewPosition");
//		glUniformMatrix4fv(viewPos,0.0f,0.0f,0.0f);//********
//
//
//
//		
...
//	Shader shaders1("Light11.vs", "Light11.frag");
//
//	Shader shaders3("Light27.vs", "Light27.frag");
//
//
//	//UPPER LIGHT
//	GLfloat vertices1[] =
